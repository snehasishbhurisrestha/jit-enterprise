...
/**
 * Title: More Post
 * Slug: cyber-security-blocks/more-post
 * Categories: cyber-security-blocks, more-post
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('More Articles &amp; Posts','cyber-security-blocks'); ?></h3>
<!-- /wp:heading -->
